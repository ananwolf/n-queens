 ...
 */
    ...
    hasRowConflictAt: function(rowIndex) {
      // if there is more than 1 index exits in one row, return true, else return false
      var count = 0;
    ...
    hasAnyRowConflicts: function() {
      //create a big container for each row
      for (var i = 0; i < this.rows().length; i++) {
        //use previous helper function to check each row
